...
\index{Client@{Client}!Client@{Client}}
\subsubsection[{\texorpdfstring{Client(const string \&)}{Client(const string &)}}]{\setlength{\rightskip}{0pt plus 5cm}Client\+::\+Client (
\begin{DoxyParamCaption}
\item[{const string \&}]{client\+String}
\end{DoxyParamCaption}
)}\hypertarget{classClient_a98a182defc2726dfa8796062cebb199c}{}\label{classClient_a98a182defc2726dfa8796062cebb199c}


\hyperlink{classClient}{Client} String Constructor. 

Constructs from string of format \char`\"{}\+First Name, Street Address, City, State, Z\+I\+P\char`\"{} comma delimited \index{Client@{Client}!Client@{Client}}
\index{Client@{Client}!Client@{Client}}
...
\hyperlink{classClient}{Client} comprehensive constructor. 
