...
\index{Client@{Client}!Client@{Client}}
\subsubsection[{\texorpdfstring{Client(const string \&nam, const string \&add, const string \&cit, const string \&st, const string \&z, const int \&client\+I\+D)}{Client(const string &nam, const string &add, const string &cit, const string &st, const string &z, const int &clientID)}}]{\setlength{\rightskip}{0pt plus 5cm}Client\+::\+Client (
...
)}\hypertarget{classClient_a8b477619887702b7a50b574819e746bd}{}\label{classClient_a8b477619887702b7a50b574819e746bd}
